...
import { MobileDownloadButton } from "@/components/ui/mobile-download-button";
import { 
  Trophy, 
  User, 
  LogOut, 
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <div className="mobile-container">
        <div className="flex h-16 items-center justify-between min-w-0">
          ...
          {/* User Menu or Mobile Download Button */}
          {user ? (
        ...
        {mobileMenuOpen && user && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col space-y-2">
              ...
              <div 
                className="flex items-center space-x-3 px-3 py-3 rounded-lg transition-colors cursor-pointer text-red-600 hover:text-red-700 hover:bg-red-50"
                onClick={() => {
