...
export const serieACompleteFixtures: SerieAMatch[] = [
  ...
  { round: 4, homeTeam: "Sassuolo", awayTeam: "Inter", date: "2025-09-15", time: "18:00" },
  ...
  { round: 4, homeTeam: "Milan", awayTeam: "Cremonese", date: "2025-09-14", time: "20:45" },
  { round: 4, homeTeam: "Pisa", awayTeam: "Juventus", date: "2025-09-14", time: "20:45" },
  ...
  { round: 5, homeTeam: "Fiorentina", awayTeam: "Sassuolo", date: "2025-09-22", time: "18:00" },
  { round: 5, homeTeam: "Udinese", awayTeam: "Cagliari", date: "2025-09-23", time: "18:30" },
  { round: 5, homeTeam: "Cremonese", awayTeam: "Pisa", date: "2025-09-23", time: "20:45" },
...
export const serieATeams2025 = [
  ...
  { id: 25, name: "Fiorentina", code: "FIO", city: "Firenze" },
  { id: 26, name: "Genoa", code: "GEN", city: "Genova" },
  { id: 27, name: "Hellas Verona", code: "HVR", city: "Verona" },
  { id: 28, name: "Inter", code: "INT", city: "Milano" },
  { id: 29, name: "Juventus", code: "JUV", city: "Torino" },
  { id: 30, name: "Lazio", code: "LAZ", city: "Roma" },
  { id: 31, name: "Lecce", code: "LEC", city: "Lecce" },
  { id: 32, name: "Milan", code: "MIL", city: "Milano" },
  { id: 33, name: "Napoli", code: "NAP", city: "Napoli" },
  { id: 34, name: "Parma", code: "PAR", city: "Parma" },
  { id: 35, name: "Pisa", code: "PIS", city: "Pisa" },
  { id: 36, name: "Roma", code: "ROM", city: "Roma" },
  { id: 37, name: "Sassuolo", code: "SAS", city: "Sassuolo" },
  { id: 38, name: "Torino", code: "TOR", city: "Torino" },
  { id: 39, name: "Udinese", code: "UDI", city: "Udine" },
  { id: 40, name: "Cremonese", code: "CRE", city: "Cremona" }
];